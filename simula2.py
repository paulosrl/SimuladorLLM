...
Versão Final: Compacta, com Fontes Médias e Usáveis.
"""
        ...
        if grupo_identificado:
            ...
            ax.text(coord_busca[0], coord_busca[1], coord_busca[2] + 0.7, 
                    ...
                    bbox=dict(boxstyle='round,pad=0.5', facecolor=cor_destaque, 
                              edgecolors='black', linewidth=2.5, alpha=0.95),
                    zorder=11)
        else:
            coord_busca = (0, 0, 2.2)
            ax.scatter(coord_busca[0], coord_busca[1], coord_busca[2], 
...
class AplicacaoLLM:
    ...
    def _configurar_estilo(self):
        ...
        # FONTES GERAIS AJUSTADAS: 16 -> 12 (aprox. -25%)
    ...
    def _criar_painel_controle(self, parent):
        ...
        control_frame.grid(row=0, column=0, sticky=(tk.W, tk.E, tk.N, tk.S), padx=(5, 5), pady=(5, 5))
        ...
        # TÍTULO AJUSTADO: 18 -> 14 (aprox. -22%)
        ...
        # ENTRADA AJUSTADA: 18 -> 14 (aprox. -22%)
        self.entrada = ttk.Entry(control_frame, font=('Arial', 14)) 
        self.entrada.grid(row=2, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
    ...
    def _criar_botoes_acao(self, parent):
        ...
        btn_frame.grid(row=3, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
    ...
    def _criar_controles_zoom_panel(self, parent):
        ...
        zoom_frame.grid(row=4, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
        
        # LABEL AJUSTADA: 16 -> 12 (aprox. -25%)
    ...
    def _criar_area_similaridades(self, parent):
        ...
        sim_frame.grid(row=5, column=0, sticky=(tk.W, tk.E), pady=(0, 10))
        sim_frame.columnconfigure(0, weight=1)
        
        # FONTE AJUSTADA: 14 -> 10 (aprox. -28%)
    ...
    def _criar_area_resultados(self, parent):
        ...
        self.resultado_texto.grid(row=7, column=0, sticky=(tk.W, tk.E, tk.N, tk.S), pady=(0, 10))
    ...
    def _criar_painel_grafico(self, parent):
        ...
        graph_frame.grid(row=0, column=1, sticky=(tk.W, tk.E, tk.N, tk.S), padx=(5, 5), pady=(5, 5))
    ...
    def analisar_texto(self):
        ...
        if not texto or len(texto) < 2:
            messagebox.showwarning("Atenção", "Texto muito curto! Digite pelo menos 2 caracteres.")
            return
